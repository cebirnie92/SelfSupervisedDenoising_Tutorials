...
- single_pix_jacobian_probe: Analysis of local weights by probing Jacobian matrix of weights of a single pixel.
- multi_pix_jacobian_probe: Analysis of local weights by probing Jacobian matrix of many pixels.
